...
class TestException:
    ...
    def test_no_such_element_exception(self, driver):
        ...
        assert row2_input_locator.is_displayed(), "Row2 input should be displayed,but its not"
    ...
    def test_element_not_interactable_exception(self, driver):
        ...
        row2_input_locator.send_keys("burger")
    ...
    def test_invalid_element_state_exception(self, driver):
        ...
        row1_input_element.send_keys("burger")
        row1_save_button = driver.find_element(By.ID, "save_btn")
        row1_save_button.click()

        # Verify text changed
        # text = row1_input_element.get_attribute("value")
        # assert text == "burger", "Expected burger but get"+ text
    ...
    def test_stale_element_reference_exception(self, driver):
        ...
        # assert not instruction_element.is_displayed(), "Instruction text element should not be displayed"
